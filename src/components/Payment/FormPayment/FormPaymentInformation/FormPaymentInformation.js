                                    ...
                                    <div className="page-content">
                                        ...
                                        <div className="form row">
                                            <div className="form-group col-12">
                                                ...
                                                <input className="form-control" type="text" name="Address_FirstName" placeholder="Enter Fullname" />
                                            </div>
                                            <div className="EmailPhone">
                                            <div className="form-group col-6">
                                                <label>Email</label>
                                                <input type="text" className="form-control" name="Address_Email" placeholder="Enter Email"  />
                                            </div>
                                            ...
                                            <div className="form-group col-6">
                                                ...
                                                <input className="form-control" type="text" name="Address_Phone" placeholder="Enter PhoneNumber"  />
                                            ...
                                            <div className="form-group col-12">
                                                ...
                                                <textarea className="form-control" name="OrderNote" cols="30" rows="2"></textarea>
                                            ...
                                            <div className="form-group col-12">
                                                    ...
                                                    <ul className="coverMethod">
                                                        ...
                                                        <li htmlFor="1" className="active">
                                                            ...
                                                            <div className="radio">
                                                                ...
                                                                <input type="radio" name="PaymentMethod" id="1" value="1"  style={{ display: 'none' }} checked />
                                                        ...
                                                        <li htmlFor="2" className=""><div className="img">
                                                ...
                                                <div className="accept-license">
                                                    ...
                                                    <input id="PaymentAgree" type="checkbox" style={{display: 'none'}} defaultChecked name="PaymentAgree"  />

                                                    <label htmlFor="PaymentAgree" className="active">I have read and agree to the above terms</label>
                                                ...
                                                <div className="form-group col-12">
                                                <button className="btn-book btn btn-next" type="submit">CheckOut Completed</button>
                                                </div>
