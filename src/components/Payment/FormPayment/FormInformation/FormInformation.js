...
class Step2 extends Component {
  ...
  next = e => {
    ...
    axios
      ...
      .then(response =>
        localStorage.setItem("idShipDelievery", response.data._id)
      )
                ...
                <div className="form row">
                  ...
                  <div className="col-12 form-group">
                    <label>
                      ...
                      <div
                        onMouseEnter={this.handleMouseHoverHouseNumber}
                        onMouseLeave={this.handleMouseHoverHouseNumber}
                        style={{ position : 'relative', bottom : '19px',right: '20px'}}
                      >
                        <span>
                        ...
                        {
                        this.state.isHoveringHouseNumber &&
                         <div className="desc">
                         <p>
                           {" "}
                    ...
                    <div className="col-12 form-group">
                      <label>
                        ...
                        <div
                        onMouseEnter={this.handleMouseHoverStreet}
                        onMouseLeave={this.handleMouseHoverStreet}
                        style={{ position : 'relative', bottom : '19px',right: '20px'}}
                      >
                        <span>
                        <i className="fas fa-info-circle" />  
                    ...
                    <div className="col-12 form-group">
                      <label>
                        Information Guide
                        <div
                        onMouseEnter={this.handleMouseHoverInfo}
                        onMouseLeave={this.handleMouseHoverInfo}
                        style={{ position : 'relative', bottom : '19px',right: '20px'}}
                      >
                        <span>
                        <i className="fas fa-info-circle" />  
